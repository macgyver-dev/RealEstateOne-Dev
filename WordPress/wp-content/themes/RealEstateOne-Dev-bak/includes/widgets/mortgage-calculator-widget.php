...
if ( ! class_exists( 'Realhomes_Mortgage_Calculator_Widget' ) ) {
	...
	class Realhomes_Mortgage_Calculator_Widget extends WP_Widget {
		...
		public function widget( $args, $instance ) {
			...
			$property_rent_status = get_option( 'theme_status_for_rent' ); // Get property status for rent.
			if ( ! has_term( $property_rent_status, 'property-status', get_the_ID() ) ) { // Display Mortgage Calculator only if current property is not for rent.
						...
						<div class="mc_left_side">
							...
							<div class="rh_mc_field">
								...
								<div class="rh_form__item">
									<select name="mc_term" class="mc_term search-select">
										<?php
