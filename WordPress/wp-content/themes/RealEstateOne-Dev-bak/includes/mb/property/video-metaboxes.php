...
function ere_video_metabox_fields( $property_metabox_fields ) {
	...
	$ere_video_fields = array(
		...
		array(
			...
			'name'    => sprintf( __( 'Virtual Tour Video URL %1$s * %2$s', 'easy-real-estate' ), '<span>', '</span>' ),
		...
		array(
			'name'             => sprintf( __( 'Virtual Tour Video Image %1$s * %2$s', 'easy-real-estate' ), '<span>', '</span>' ),
			'desc'             => sprintf(
				__(
					'Provide an image of minimum width 818px and minimum height 417px. Bigger size images will be cropped automatically. Property featured image will be shown if no image is selected.
