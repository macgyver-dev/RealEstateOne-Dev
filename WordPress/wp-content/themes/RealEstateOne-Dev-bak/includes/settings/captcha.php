		...
		<table class="form-table">
			...
			<tr>
				...
				<td>
					...
					<p class="description"><?php printf( esc_html__( 'You can get new keys for your website by %1$s signing in here %2$s', 'easy-real-estate' ), '<a href="https://www.google.com/recaptcha/admin#whyrecaptcha" target="_blank">', '</a>' ); ?></p>
				</td>
			</tr>
			<tr>
