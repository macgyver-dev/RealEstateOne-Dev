		...
		<table class="form-table">
			...
			<tr>
				...
				<td>
					...
					<p class="description"><?php printf( esc_html__( 'You can create Google Maps styles JSON using %1$s Google Styling Wizard %2$s or %3$s Snazzy Maps %4$s.', 'easy-real-estate' ), '<a href="https://mapstyle.withgoogle.com/" target="_blank">', '</a>', '<a href="https://snazzymaps.com/" target="_blank">', '</a>' ); ?></p>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					<p class="description"><?php printf( esc_html__( 'You can use %1$s OR %2$s to get Latitude and longitude of your desired location.', 'easy-real-estate' ), '<a href="http://www.latlong.net/" target="_blank">latlong.net</a>', '<a href="https://getlatlong.net/" target="_blank">getlatlong.net</a>' ); ?></p>
				</td>
			</tr>
			<tr style="border-top: 1px solid #dddddd;">
				<th scope="row">
