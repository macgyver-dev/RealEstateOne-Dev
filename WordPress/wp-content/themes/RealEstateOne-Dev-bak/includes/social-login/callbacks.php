...
if ( ! function_exists( 'ere_google_oauth_login' ) ) {
	...
	function ere_google_oauth_login() {
		...
		require_once ERE_PLUGIN_DIR . 'includes/social-login/libs/google/Google_Client.php';
		require_once ERE_PLUGIN_DIR . 'includes/social-login/libs/google/contrib/Google_Oauth2Service.php';

		if ( class_exists( 'Google_Client' ) && class_exists( 'Google_Oauth2Service' ) && null !== ere_social_login_app_keys( 'google' ) ) {
